...
/// A Flutter implementation of the [TodosProvider] that uses local storage.
/// {@endtemplate}
@LazySingleton(as: TodosProvider)
class LocalStorageTodosProvider extends TodosProvider {
  /// {@macro local_storage_todos_provider}
